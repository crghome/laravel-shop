@if(!empty($collectCategories) && count($collectCategories))
<div class="row">
    <div class="col-12" style="margin-bottom: 15px;"><h3>Categories component</h3></div>
    @foreach ($collectCategories as $item)
